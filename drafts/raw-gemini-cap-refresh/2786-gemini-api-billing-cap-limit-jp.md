...
<!-- wp:paragraph -->
<p><strong>追記（2026-03-25）:</strong> その後、Google AI Studio 側に <code>Spend caps</code> が追加され、プロジェクト単位の月額上限 UI が見えるようになりました。最新状況は <a href="https://www.zidooka.com/archives/4103">こちらの新記事</a> に整理しています。</p>
<!-- /wp:paragraph -->
