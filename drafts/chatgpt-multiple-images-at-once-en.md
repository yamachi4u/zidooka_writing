---
title: "ChatGPT \"You can now make multiple images at a time\" — It's Not an Error, It's a Feature Announcement"
slug: "chatgpt-multiple-images-at-once-en"
status: "publish"
categories: 
  - "AI"
tags: 
...
It's **an announcement that things got more convenient**,
so feel free to keep requesting images without worry.
...
Previously, it was:
"1st image → wait → 2nd image → wait → 3rd image → wait"

Now it's:
"Request 3 images together → wait for all"
...
Since the free plan has limitations on image generation itself,
this simultaneous generation feature is presumably primarily for paid plans.
...
"Let me throw in the next request while I'm waiting"
