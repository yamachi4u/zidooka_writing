...
![CLIの実行画面](../images/2025/cli-demo-1.png)
...
2.  **画像の自動アップロード**: 記事内に `![alt](../images/2025/pic.png)` と書くだけで、投稿時に画像を自動でアップロードし、リンクを差し替えてくれます。
...
![403エラーのログ](../images/2025/cli-demo-3.png)
...
![VS Codeでの執筆風景](../images/2025/cli-demo-4.png)
