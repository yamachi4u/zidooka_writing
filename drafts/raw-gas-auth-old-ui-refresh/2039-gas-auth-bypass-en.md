...
<!-- wp:paragraph -->
<p>This article covers the older UI where you still see <code>Advanced</code> and then <code>Go to {app} (unsafe)</code>. If you are seeing the newer <code>Continue</code> / <code>Back to safety</code> tester warning, that is a different flow.</p>
<!-- /wp:paragraph -->
