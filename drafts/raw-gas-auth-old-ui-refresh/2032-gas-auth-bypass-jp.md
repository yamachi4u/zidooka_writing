...
title: "【GAS・旧UI】「このアプリはGoogleによって確認されていません」と出た時の承認手順｜Advancedが出る場合"
status: "publish"
...
<!-- wp:paragraph -->
<p>この記事は、左下に <code>詳細 (Advanced)</code> が出て、そこから <code>安全ではないページに移動</code> する旧UIベースの手順です。最近の <code>Continue</code> / <code>Back to safety</code> 画面については別記事で整理しています。</p>
<!-- /wp:paragraph -->
