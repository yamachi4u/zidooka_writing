        ...
        <div class="col-span-1">
            ...
            <div class="svg-converter-container">
                ...
                <div class="bg-white shadow-sm rounded-lg mb-4">
                    <div class="px-4 py-3 bg-blue-600 text-white rounded-t-lg">
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                            ...
                            <div class="lg:col-span-6">
                                <h3 class="text-base font-semibold mb-3 border-b pb-2">SVGコード</h3>
                                <textarea id="svg-code" class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-3" rows="8" 
                                    placeholder="ここにSVGコードを入力してください...例: <svg width='100' height='100'><circle cx='50' cy='50' r='40' fill='red'/></svg>"></textarea>
                                
                                <div class="mb-3">
                                    <button id="preview-btn" class="inline-flex items-center rounded-md bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700">プレビュー</button>
                                    <button id="clear-btn" class="inline-flex items-center rounded-md bg-red-600 px-3 py-2 text-sm font-medium text-white hover:bg-red-700">クリア</button>
                                    <label class="inline-flex items-center rounded-md border border-gray-400 text-gray-700 hover:bg-gray-50 px-3 py-2 text-sm font-medium ml-2 cursor-pointer">
                                ...
                                <div class="sample-buttons">
                                    ...
                                    <button id="sample-circle" class="inline-flex items-center rounded-md border border-gray-400 text-gray-700 hover:bg-gray-50 px-2 py-1 text-xs">円</button>
                                    <button id="sample-rect" class="inline-flex items-center rounded-md border border-gray-400 text-gray-700 hover:bg-gray-50 px-2 py-1 text-xs">四角形</button>
                                    <button id="sample-path" class="inline-flex items-center rounded-md border border-gray-400 text-gray-700 hover:bg-gray-50 px-2 py-1 text-xs">パス</button>
                                </div>
                            </div>
                            
                            <!-- プレビューセクション -->
                            <div class="lg:col-span-6">
                                <h3 class="text-base font-semibold mb-3 border-b pb-2">プレビュー</h3>
