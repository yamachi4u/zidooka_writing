                            ...
                            <article id="post-<?php the_ID(); ?>" <?php post_class('group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-md'); ?>>
                                <a href="<?php the_permalink(); ?>" class="block overflow-hidden">
                                    ...
                                    if (function_exists('the_optimal_thumbnail')) {
                                        ...
                                        echo '<img src="' . esc_url(defined('ZDK_OGP_FALLBACK_IMAGE') ? ZDK_OGP_FALLBACK_IMAGE : 'https://www.zidooka.com/wp-content/uploads/2024/05/Slide-16_9-1.png') . '" class="h-44 w-full object-cover" alt="' . esc_attr(get_the_title()) . '" loading="lazy">';
                                    }
                                    ?>
                                </a>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <ul class="mt-4 space-y-2 text-sm text-slate-600">
                        ...
                        foreach ($parent_categories as $parent) {
                            ...
                            echo '<li>';
                            if ($has_children) {
                                echo '<button class="flex w-full items-center justify-between text-left text-slate-700" aria-expanded="false" onclick="toggleCategory(this)">';
                                ...
                                <div class="flex items-start gap-3">
                                    <div class="h-14 w-14 overflow-hidden rounded-lg bg-slate-100">
                                        ...
                                        if (function_exists('the_optimal_thumbnail')) {
                                            ...
                                            echo '<img src="' . esc_url(defined('ZDK_OGP_FALLBACK_IMAGE') ? ZDK_OGP_FALLBACK_IMAGE : 'https://www.zidooka.com/wp-content/uploads/2024/05/Slide-16_9-1.png') . '" class="h-full w-full object-cover" alt="' . esc_attr(get_the_title()) . '" loading="lazy">';
                                        }
                                        ?>
                                    </div>
                                    <div>
