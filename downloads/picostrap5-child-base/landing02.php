<?php
/*
Template Name: Zidooka Template Modern
*/
?>
<!DOCTYPE html>
...
:root {
  --primary: #2563eb;      /* シンプルな青 */
  --primary-dark: #1d4ed8;
  --secondary: #16a34a;    /* グリーン */
      ...
      <div class="row g-4 mb-5">
        ...
        <div class="col-md-4">
          <div class="stats-item">
            ...
            <p class="lead mb-0">平均評価（5点満点）<br> ※クラウドソージングサイトの評価=25年3月時点</p>
          </div>
        </div>
      </div>
      <div class="row g-4">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="testimonial-card">
            ...
            <h5 class="h6 fw-bold">Google Apps Script</h5>
            <small class="text-muted">2024年05月07日</small>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-8">
          <div class="accordion" id="qaAccordion">
            <div class="accordion-item">
              <h2 class="accordion-header" id="qa1Header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#qa1" aria-expanded="false" aria-controls="qa1">
                  納期はどのくらいかかりますか？
                </button>
              </h2>
              <div id="qa1" class="accordion-collapse collapse" aria-labelledby="qa1Header" data-bs-parent="#qaAccordion">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="qa2Header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#qa2" aria-expanded="false" aria-controls="qa2">
                  予算の目安はどのくらいですか？
                </button>
              </h2>
              <div id="qa2" class="accordion-collapse collapse" aria-labelledby="qa2Header" data-bs-parent="#qaAccordion">
                <div class="accordion-body">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="qa3Header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#qa3" aria-expanded="false" aria-controls="qa3">
                  連絡手段はどのようになりますか？
                </button>
              </h2>
              <div id="qa3" class="accordion-collapse collapse" aria-labelledby="qa3Header" data-bs-parent="#qaAccordion">
                <div class="accordion-body">
                  メール（<strong>main@gmail.com</strong>）やZoom、Chatworkなどに対応します。クラウドワークス経由での連絡・契約も歓迎です。
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="qa4Header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#qa4" aria-expanded="false" aria-controls="qa4">
                  追加で機能を依頼したい場合はどうすればいいですか？
                </button>
              </h2>
              <div id="qa4" class="accordion-collapse collapse" aria-labelledby="qa4Header" data-bs-parent="#qaAccordion">
                <div class="accordion-body">
          ...
          <div class="text-center mt-4">
            <a href="#contact" class="btn btn-primary btn-lg">今すぐ問い合わせる</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="profile-card">
        <ul>
            ...
            <span>Zidooka!(個人事業主、京都市在住、氏名：山口和紀)
            </span>
          </li>
          <li>
          ...
          <li>
            <i class="fas fa-code"></i>
            <span>プログラミング／エンジニアリング歴 10年</span>
          </li>
          <li>
            <i class="fas fa-laptop-code"></i>
            <span>HP制作、業務自動化</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section id="contact" class="py-5 bg-light">
    <div class="container">
      ...
      <p class="text-center mb-5">
        メールでのご連絡は<strong>main@zidooka.com</strong>までお願いいたします。<br>
        <a href="https://crowdworks.jp/public/employers/1459615">クラウドワークス</a>等の他プラットフォームでの連絡も歓迎です。
      </p>
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="card border-0 shadow-sm">
            <div class="card-body">
              <h4 class="card-title mb-3">無料相談フォーム</h4>
              <p class="card-text">
                予算や納期のイメージを記載いただくとスムーズです。<br>
                依頼内容が漠然としている場合もお気軽にご入力ください。24時間以内に返事をするようにします（3営業日ほどかかる場合があります）。
              </p>
              <div class="d-grid gap-2">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdsaBbQn208NuejNs3UPCx_AXsP0cImtvLStGAhQ2Ob92e23Q/viewform?usp=dialog" class="btn btn-primary" target="_blank" rel="noopener noreferrer">
                  無料相談フォームを開く（Googleフォームが開きます）
                </a>
              </div>
            </div>
          </div>
          <div class="text-center mt-4">
            <p class="mb-2">すぐに相談したい場合はこちらから</p>
            <a href="mailto:main@zidooka.com" class="btn btn-outline-primary">メールで直接連絡する</a>
          </div>
        </div>
      </div>
    </div>
